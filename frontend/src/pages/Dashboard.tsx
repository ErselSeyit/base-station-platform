                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <Box
                        sx={{
                          ...
                          height: 8,
                          borderRadius: '50%',
                          bgcolor: getStatusBgColor(station.status),
                        }}
                      />
