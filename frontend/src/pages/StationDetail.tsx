...
import { MetricData, Notification, StationStatus } from '../types'
    ...
    <Box>
      <Box display="flex" alignItems="center" gap={2} mb={3}>
        ...
        <Chip
          ...
          color={getStatusColor(stationData.status) as 'success' | 'warning' | 'error' | 'default'}
        />
      </Box>
          ...
          <Card>
            <CardContent>
              ...
              {latestMetrics.length > 0 ? (
                latestMetrics.map((metric: MetricData, index: number) => (
                  <Paper
                    key={index}
                    sx={{
                      p: 2,
