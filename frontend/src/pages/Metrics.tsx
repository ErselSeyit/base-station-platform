...
// Lazy load chart component to defer 412KB recharts bundle
const MetricsCategoryChart = lazy(() => import('../components/MetricsCategoryChart'))
import {
  CARD_STATUS_STYLES,
  CSS_VARS,
...
const CategorySection = ({ category, metrics, chartData, baseDelay, days }: CategorySectionProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Chart - lazy loaded to defer 412KB recharts bundle */}
      <Suspense fallback={<Skeleton variant="rectangular" height={300} sx={{ borderRadius: '14px' }} />}>
