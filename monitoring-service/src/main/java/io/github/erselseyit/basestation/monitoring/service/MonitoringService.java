...
import static io.github.erselseyit.basestation.monitoring.config.RedisConfig.METRICS_CACHE;
...
import io.github.erselseyit.basestation.monitoring.model.MetricData;
...
public class MonitoringService {
    ...
    public MetricDataDTO recordMetric(MetricDataDTO dto) {
        ...
        if (metric.getUnit() == null || metric.getUnit().isEmpty()) {
            metric.setUnit(io.github.erselseyit.basestation.monitoring.model.MetricUnit.getUnitForMetricType(metric.getMetricType()));
        }
