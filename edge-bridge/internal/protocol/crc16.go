// Package protocol implements the device protocol for edge bridge communication.
package protocol
...
// CalculateCRC16 computes CRC-16-CCITT for the given data.
...
// UpdateCRC16 updates a running CRC with additional data.
...
// VerifyCRC16 checks if the CRC at the end of data is valid.
