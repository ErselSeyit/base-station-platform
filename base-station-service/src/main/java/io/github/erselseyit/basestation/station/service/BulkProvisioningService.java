...
import io.github.erselseyit.basestation.station.dto.BulkImportRequest;
import io.github.erselseyit.basestation.station.dto.BulkImportRequest.ImportOptions;
import io.github.erselseyit.basestation.station.dto.BulkImportRequest.StationImportItem;
import io.github.erselseyit.basestation.station.dto.BulkImportResponse;
import io.github.erselseyit.basestation.station.dto.BulkImportResponse.ImportResult;
...
import io.github.erselseyit.basestation.station.tenant.TenantContext;
...
public class BulkProvisioningService {
     ...
     */
    @Transactional(readOnly = true)
    public List<BaseStation> exportStationsByStatus(io.github.erselseyit.basestation.station.model.StationStatus status) {
        Long orgId = TenantContext.getCurrentOrganizationId();
        if (orgId != null) {
