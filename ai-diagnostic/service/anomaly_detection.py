...
# Isolation Forest extracted to service/isolation_forest.py; re-exported so
# importers (from ...anomaly_detection import IsolationForest) keep working.
from .isolation_forest import IsolationTree, IsolationForest  # noqa: F401
